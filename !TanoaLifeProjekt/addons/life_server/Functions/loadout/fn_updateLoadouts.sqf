...
_active		= [_active] call DB_fnc_mresString;
_ld1 		= [_ld1] call DB_fnc_mresArray;
_ld2 		= [_ld2] call DB_fnc_mresArray;
_ld3 		= [_ld3] call DB_fnc_mresArray;
_ld4 		= [_ld4] call DB_fnc_mresArray;
_ld5 		= [_ld5] call DB_fnc_mresArray;
