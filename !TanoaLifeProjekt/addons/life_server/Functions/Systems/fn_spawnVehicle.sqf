...
[1,"Dein Fahrzeug wurde versichert ausgeparkt!"] remoteExecCall ["life_fnc_broadcast",_unit];
}else{
[1,"Dein Fahrzeug wurde unversichert ausgeparkt!"] remoteExecCall ["life_fnc_broadcast",_unit];
};
serv_sv_use deleteAt _servIndex;
